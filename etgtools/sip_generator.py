...
class SipWrapperGenerator(generators.WrapperGeneratorBase):
    ...
    def generate(self, module, destFile=None):
        ...
        if not destFile:
            destFile = os.path.join(cfg.ROOT_DIR, cfg.SIPGEN, module.name + '.sip')
...
// This file is generated by the ETG SIP generator.  Do not edit by hand.
//
// Copyright: (c) %s by %s
// License:   %s
""" % (cfg.COPYRIGHT_YEAR, cfg.COPYRIGHT_HOLDER, cfg.LICENSE_NAME))
...
""" % (module.package, module.name, cfg.COPYRIGHT_YEAR, cfg.COPYRIGHT_HOLDER, cfg.LICENSE_NAME))
...
""" % ( module.name, doc, module.name, cfg.COPYRIGHT_YEAR, cfg.COPYRIGHT_HOLDER, cfg.LICENSE_NAME))
    ...
    def generateParameters(self, parameters, stream, indent):
        ...
        for idx, param in enumerate(parameters):
            if param.ignored:
                continue
            # Handle FunctionName(void) parameter definitions
            if param.type == 'void' and not param.name:
                continue
            stream.write(indent)
